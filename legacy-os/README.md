# Playbit Legacy OS Open Source

**Playbit is not actively working on our previous OS project.** The remaining portions of this readme file are only minimally updated and is intended to reflect its contents prior to our pause on the OS project.
...
$ git clone https://github.com/playbit/public.git /src && cd /src/legacy-os
```
